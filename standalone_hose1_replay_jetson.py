...
# LeRobot SOFollower.configure()와 동일한 값
P_COEFFICIENT = 16
...
def write_1byte(port_handler, packet_handler, motor_id, address, value):
    ...
    # Jetson scservo_sdk에서는 port_handler를 다시 전달하지 않음
...
def send_positions(group_sync_write, packet_handler, frame):
    ...
    for motor_name, motor_id in MOTORS.items():
        ...
        # Jetson SDK에서는 sms_sts 객체의 byte helper 사용
        param_goal_position = [
...
def main():
    ...
    print("========================================")
    print(" SO-100 Hose1 RAW CSV Replay - Jetson")
    print("========================================")
    print()
    ...
    try:
        ...
        print()
        print("HOSE1 REPLAY FINISHED")
        print("Torque remains ENABLED.")
        print("Robot will hold the spraying position.")
        ...
        print("Port closed.")
        print("Torque state was not changed on normal completion.")
        print("Done.")
